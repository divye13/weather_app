...
class DailyForecast extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final int timezoneOffset = forecast.timezone; 

    // Group forecast items by local date
    ...
    final dailySummaries = groupedByDay.entries.map((entry) {
      ...
      // Special case: If it's today, use all today's data
          ...
          Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                //today's date in the forecast location timezone
